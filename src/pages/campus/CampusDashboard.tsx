...
export function CampusDashboard() {
  const [reports, setReports] = useState<adminApi.Reports | null>(null);
  const [analytics, setAnalytics] = useState<adminApi.Analytics | null>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatsCard title="Total Feedback" value={reports?.totalFeedback ?? 0} icon={SearchIcon} color="green" />
