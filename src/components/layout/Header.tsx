...
export function Header({ toggleSidebar, role }: HeaderProps) {
  ...
  const notifications = isSystemAdmin ?
  [
  {
    id: 1,
    icon: AlertCircleIcon,
    title: 'New admin registration',
    desc: 'Evan Wright requested system access.',
    time: '2h ago',
  ...
  },
  {
    ...
    desc: 'No critical issues found this week.',
    time: '1d ago',
  ...
  },
  {
    ...
    desc: 'Charlie Brown has not logged in for 30+ days.',
    time: '2d ago',
  ...
  [
  {
    ...
    desc: '3 unreviewed feedback items on Kimberlin Library.',
    time: '1h ago',
  ...
  },
  {
    ...
    desc: 'Queens Building details were edited.',
    time: '5h ago',
  ...
  },
  {
    ...
    icon: BuildingIcon,
    title: 'Staff added',
    desc: 'New staff member assigned to Hugh Aston.',
    time: '1d ago',
    color: 'text-emerald-600 bg-emerald-50 dark:bg-emerald-900/30'
  }];
