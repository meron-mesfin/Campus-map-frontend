export interface Location {
  id: string;
  name: string;
  type: 'Classroom' | 'Office' | 'Lab' | 'Library' | 'Cafeteria' | 'Other';
  description: string;
  lat: number;
  lng: number;
  imageUrl?: string;
...
export interface ActivityLog {
  ...
  userId: string;
  userName: string;
  action: 'Create' | 'Update' | 'Delete' | 'Login' | 'Review';
  details: string;
  timestamp: string;
}
...
},
{
  ...
  buildingId: '1', // Vijay Patel Building
  room: 'VP 1.05'
},
{
  id: '4',
  ...
  buildingId: '2', // Hugh Aston Building
  room: 'HA 4.22'
},
{
  id: '5',
  ...
  buildingId: '6', // Hawthorn Building
  room: 'HB 1.12'
}];
